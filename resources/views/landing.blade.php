    ...
    <footer class="bg-slate-900 text-slate-300 py-12">
        <div class="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center">
            <div class="mb-4 md:mb-0">
                ...
                <p class="text-sm mt-2 text-slate-400">© {{ date('Y') }} PriceChecker. Все права защищены.</p>
            </div>
            <div class="flex space-x-6">
                <a href="/admin" class="hover:text-white transition-colors">Панель администратора</a>
                <a href="{{ route('documentation') }}" class="hover:text-white transition-colors">Документация</a>
                <a href="mailto:{{ config('mail.from.address') }}" class="hover:text-white transition-colors">Поддержка</a>
            </div>
        </div>
    </footer>
