...
<body class="antialiased text-slate-800 bg-slate-50">
            ...
            <section id="support" class="scroll-mt-28 border-t border-slate-200 pt-10 mt-10">
                <div class="bg-gradient-to-br from-slate-900 to-slate-800 text-white rounded-2xl p-8 md:p-12 text-center relative overflow-hidden">
                    <div class="relative z-10">
                        ...
                        <a href="mailto:<?php echo e(config('mail.from.address')); ?>" class="inline-flex items-center justify-center px-8 py-3 text-base font-semibold text-slate-900 bg-white rounded-full hover:bg-indigo-50 transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
    ...
    <footer class="bg-white border-t border-slate-200 mt-24 py-12">
        <div class="container mx-auto px-6 text-center text-slate-500">
            <p>&copy; <?php echo e(date('Y')); ?> PriceChecker. Сделано для эффективного бизнеса.</p>
        </div>
    </footer>
...
<?php /**PATH /var/www/html/resources/views/documentation.blade.php ENDPATH**/ ?>